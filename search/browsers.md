...
- [Chromnius](https://www.chromnius.com/) *(considered as malware)* - provides a cross-platform browser that makes use of a unique Blink Browser Engine.
	- **Engine** - Blink
	- **Operating System** - Windows
- [Cypto Browser Search](https://www.awdev.my.id/search/crypto/index.html) - is a free, fast & 100% private app that stops all types of online tracking and monitoring.
	- **Engine** -
...
- [Citrio Browser](http://citrio.com/) *(considered as malware)* - is a fast, polished browser which demonstrates excellent performance.
	- **Engine** -
	- **Operating System** -
- [CSE Browser](https://awdevmyid.github.io/search/cse.html) - is a free, fast & 100% private app that stops all types of online tracking and monitoring.
	- **Engine** -
	- **Operating System** - Windows, macOS, Linux, iOS Android
...
- [CyberGhost Browser](https://www.cyberghostvpn.com/en_US/private-browser) - is a free, fast & 100% private app that stops all types of online tracking and monitoring.
	- **Engine** -
	- **Operating System** - Windows, macOS, Linux, iOS Android
- [Costume Browser](https://www.awdev.my.id/search/cse.html) - is a free, fast & 100% private app that stops all types of online tracking and monitoring.
	- **Engine** -
	- **Operating System** - Windows, macOS, Linux, iOS Android
...
- [Synth](https://synth.app/) - AI Driven Browser that makes you smarter at research and work.
	- **Engine** - 
	- **Operating System** - 
- [Search Cypto](https://awdevmyid.github.io/search/crypto)
 - **Crypto Search**
 - **Operating System** -
...
- [Search Youtube](https://www.awdev.my.id/youtube/downloader.html)- Search Youtube Vidio and Music Downloader Free.

**Credits for contribution to**
- [norafroud](https://github.com/norafroud)
- [mikrodinet](https://github.com/mikrodinet)
- [CostcoFanboy](https://github.com/CostcoFanboy)
- [dev](https://github.com/wahyu9kdl)
- [anuragrao04](https://github.com/anuragrao04)
- [niutech](https://github.com/niutech)
- [awdevmyid](https://github.com/awdevmyid)
